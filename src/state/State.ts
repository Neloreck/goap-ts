...
export class State<T = any> {
   ...
   *   a worldState. Has no effect in Actions being taken. Do NOT set this to Integer.MaxValue since this causes the
   *   goal to be removed from the HashSet by the Planner.
