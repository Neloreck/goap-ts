...
export interface IImportantUnitChangeEventListener {
   ...
   * of the unit. This causes the Idle Stack to create a Queue specifically for this GoapState, which is empty
   ...
   *
   * @param newGoalState - the new goal that the GoapUnit is going to accomplish.
   */
